...
## 향후 계획
1. 현재의 모든 기능들에 대한 테스트 코드 작성
2. 테스트 코드 기반으로 코드 리팩토링
3. 카카오, 네이버, 구글 소셜로그인 구현
4. 성경 영어 버전 도입(외부 API 연동)
5. 오늘의 말씀 기능(외부 API 연동) & 푯대말씀 기능
6. 성경 함께 읽기 기능 - 팀 혹은 단체를 만들고, 공통된 성경읽기표를 공유하며 함께 성경을 읽을 수 있게 하는 기능
